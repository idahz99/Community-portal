...
$qry3 = "SELECT * FROM training_table WHERE id_pembekal= $id ";
...
<meta charset="UTF-8">
   ...
   <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="align-content: center ">
    ...
    <div style="height:10vh;padding-top:4vh;padding-left:10px"><h1>Senarai Kursus latihan<h1></div>
        ...
        while($row=$record3->fetch_array()){ ?>
             <tr>
                  ...
                  <td><?php echo $row['training_ID']; ?></td>
                    ...
                    <td><a href="edittraining.php?id=<?php echo $row['training_ID'];?>"><i class="fa-regular fa-pen-to-square"></i></a>
                   
                    <a style="color:red"href="delete.php?id=<?php echo $row['training_ID'];?>"><i class="far fa-trash-alt"></i></a>
                    </td>
                     </tr>
         <?php }}?>
