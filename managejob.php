...
if(isset($_GET['status']) AND $_GET['status']== 'deleted'){
    echo'<script>alert("Perkerjaan telah dipadam")</script>';
}
global $conn;    
...
<head>
    ...
    <title>Mengurus jawatan perkerjaan</title>
   ...
   <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="align-content: center ">
    ...
    <h1>Mengurus Jawatan Perkerjaan</h1>
...
<table id= "myTable"  class="ui celled table" style="width:100%" >
        ...
        while($row=$record1->fetch_array()){ ?>
             ...
             <td><?php echo $row['job_id']; ?></td>
                    ...
                    <td> <a style="color:red"href="admindelete.php?id=<?php echo $row['job_id'];?>"><i class="far fa-trash-alt"></i></a></td>
                     </tr>
         <?php }}?>
